...
export function CardImage({ href, title, meta, image }: { href: string; title: string; meta?: string; image?: MediaDTO }) {
  return (
    <Link href={href as Route} className="stone-panel group block p-3 focus-visible:outline-accent">
      ...
      <div className="flex items-start justify-between gap-4 p-3">
        <div>
          <h2 className="font-heading text-3xl uppercase leading-tight">{title}</h2>
