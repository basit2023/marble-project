...
function cnWhatsapp(focused: boolean) {
  return `fixed bottom-5 right-5 z-30 grid size-14 place-items-center rounded-full bg-accent text-white shadow-xl transition ${focused ? "max-sm:translate-y-24" : ""}`;
}
